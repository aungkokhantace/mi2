    ...
    public function run()
{
    ...
    $objs = array(
        ...
        ['id'=>11, 'name'=>'Home','description'=>'Home description',
            ...
            <div class="slider-header"><!--[if gte mso 9]><xml>
...
<![endif]-->18th Myanmar Internal Medicine Conference<br>(In Conjunction with 4th AFIM Congress and 4th ACP South East Asian Chapter Meeting)</div>
            ...
            <!-- end of Carousel & header section --><br><!--[if gte mso 9]><xml>
 <o:OfficeDocumentSettings>
  <o:AllowPNG></o:AllowPNG>
 </o:OfficeDocumentSettings>
</xml><![endif]--><!--[if gte mso 9]><xml>
...
<p class="MsoNormal"><span style="font-family:" zawgyi-one","sans-serif""="">WELCOME
...
" times="" new="" roman","serif";mso-bidi-font-family:"times="" roman";mso-bidi-theme-font:="" minor-bidi;mso-no-proof:yes"="">&nbsp;</span></p>
...
STATEMENT</span><span style="font-family: Zawgyi-One, sans-serif;">&nbsp;</span></p>
...
<p class="MsoNormal"><span style="font-family:" zawgyi-one","sans-serif""="">OUR
VISION<o:p></o:p></span></p>

<p class="MsoNormal"><span style="font-family:" zawgyi-one","sans-serif""="">To
broaden the horizons by harmonization <o:p></o:p></span></p>
...
<p class="MsoNormal"><span style="font-family:" zawgyi-one","sans-serif""="">Venue<o:p></o:p></span></p>
...
<p class="MsoNormal"><span style="font-family:" zawgyi-one","sans-serif""="">Date<o:p></o:p></span></p>
...
<p class="MsoNormal"><span style="font-family:" zawgyi-one","sans-serif""="">Early
...
<p class="MsoNormal"><span style="font-family:" zawgyi-one","sans-serif""="">Abstract
Submission Deadline<o:p></o:p></span></p>

<p class="MsoNormal"><span style="font-family:" zawgyi-one","sans-serif""="">30<sup>th</sup>
April 2017</span></p>',
            'status' =>'active', 'url' =>'home', 'title' =>'Home title', 'page_menu_order' =>'1', 'events_id' =>'1', 'templates_id' =>'1', 'created_by' =>'1', 'updated_by' =>'1', 'created_at' =>'2017-01-30 09:19:53', 'updated_at' =>'2017-01-30 09:19:53' ],

        ['id'=>12, 'name'=>'Register','description'=>'Register description',
            'content' =>' <!-- Carousel & header section -->
        <div class="slider-header"><span style="font-size: 11px;">﻿</span><span style="font-size: 11px;">﻿</span><span style="font-size: 11px;">﻿</span><span style="font-size: 11px;">﻿</span><span style="font-size: 11px;">﻿</span>18th Myanmar Internal Medicine Conference<br>(In Conjunction with 4th AFIM Congress and 4th ACP South East Asian Chapter Meeting)</div>
...
<p><span style="font-size: 11px;">﻿</span><span style="font-size: 11px;">﻿</span></p><p><span style="font-size: 11px;"><br></span><span style="font-family: Zawgyi-One, sans-serif;">Registration
...
<a href="/register/create"><button type="button" class="btn btn-primary down">Register Now</button></a>',
            'status' =>'active', 'url' =>'home/register', 'title' =>'Register title', 'page_menu_order' =>'1', 'events_id' =>'1', 'templates_id' =>'1', 'created_by' =>'1', 'updated_by' =>'1', 'created_at' =>'2017-01-30 09:19:53', 'updated_at' =>'2017-01-30 09:19:53' ],
...
</xml><![endif]--><span style="font-size: 11px;">﻿</span><!--[if gte mso 9]><xml>
 <w:WordDocument>
  <w:View>Normal</w:View>
  <w:Zoom>0</w:Zoom>
  <w:TrackMoves></w:TrackMoves>
...
</xml><![endif]--><span style="font-size: 11px;">﻿</span><!--[if gte mso 10]>
<style>
 /* Style Definitions */
 table.MsoNormalTable
	{mso-style-name:"Table Normal";
...
<![endif]-->18th Myanmar Internal Medicine Conference<br>(In Conjunction with 4th AFIM Congress and 4th ACP South East Asian Chapter Meeting)</div>
    ...
    <!-- end of Carousel & header section --><!--[if gte mso 9]><xml>
 <o:OfficeDocumentSettings>
  <o:AllowPNG></o:AllowPNG>
 </o:OfficeDocumentSettings>
</xml><![endif]--><!--[if gte mso 9]><xml>
...
<p class="MsoNormal"><b style="mso-bidi-font-weight:normal"><u><span style="font-family:" zawgyi-one","sans-serif""=""><br></span></u></b></p><p class="MsoNormal"><b style="mso-bidi-font-weight:normal"><u><span style="font-family:" zawgyi-one","sans-serif""="">Now Accepting Abstracts</span></u></b></p>
...
',
            'status' =>'active', 'url' =>'home/abstract', 'title' =>'Abstract title', 'page_menu_order' =>'1', 'events_id' =>'1', 'templates_id' =>'1', 'created_by' =>'1', 'updated_by' =>'1', 'created_at' =>'2017-01-30 09:19:53', 'updated_at' =>'2017-01-30 09:19:53' ],
...
',
            'status' =>'active', 'url' =>'home/exhibitor', 'title' =>'Exhibitor title', 'page_menu_order' =>'1', 'events_id' =>'1', 'templates_id' =>'1', 'created_by' =>'1', 'updated_by' =>'1', 'created_at' =>'2017-01-30 09:19:53', 'updated_at' =>'2017-01-30 09:19:53' ],

        ['id'=>15, 'name'=>'Conference','description'=>'Conference description',
            'content' =>'        <div class="slider-header"><!--[if gte mso 9]><xml>
 <o:OfficeDocumentSettings>
  <o:AllowPNG></o:AllowPNG>
 </o:OfficeDocumentSettings>
</xml><![endif]--><span style="font-size: 11px;">﻿</span><!--[if gte mso 9]><xml>
...
<![endif]-->18th Myanmar Internal Medicine Conference<br>(In Conjunction with 4th AFIM Congress and 4th ACP South East Asian Chapter Meeting)</div>
        ...
        <h3>Conference Information</h3><p><!--[if gte mso 9]><xml>
 <o:OfficeDocumentSettings>
  <o:AllowPNG></o:AllowPNG>
 </o:OfficeDocumentSettings>
</xml><![endif]--><!--[if gte mso 9]><xml>
...
information: AP Thein Myint <a href="mailto:drthanemyint@gmail.com">drthanemyint@gmail.com</a> </span></p><p><span style="font-size:11.0pt;line-height:107%;font-family:" zawgyi-one","sans-serif";="" mso-fareast-font-family:calibri;mso-fareast-theme-font:minor-latin;mso-ansi-language:="" en-us;mso-fareast-language:en-us;mso-bidi-language:ar-sa"=""><br></span></p>',
            'status' =>'active', 'url' =>'home/conference', 'title' =>'Conference title', 'page_menu_order' =>'1', 'events_id' =>'1', 'templates_id' =>'1', 'created_by' =>'1', 'updated_by' =>'1', 'created_at' =>'2017-01-30 09:19:53', 'updated_at' =>'2017-01-30 09:19:53' ],

        ['id'=>16, 'name'=>'Other','description'=>'Other description',
            'content' =>' <!-- Carousel & header section -->
        <div class="slider-header"><span style="font-size: 11px;">﻿</span><span style="font-size: 11px;">﻿</span>18th Myanmar Internal Medicine Conference<br>(In Conjunction with 4th AFIM Congress and 4th ACP South East Asian Chapter Meeting)</div>
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <a class="right carousel-control" href="#carousel-example-generic" role="button" data-slide="next">
                <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>
                <span class="sr-only">Next</span></a></div>',
            'status' =>'active', 'url' =>'home/other', 'title' =>'Other title', 'page_menu_order' =>'1', 'events_id' =>'1', 'templates_id' =>'1', 'created_by' =>'1', 'updated_by' =>'1', 'created_at' =>'2017-01-30 09:19:53', 'updated_at' =>'2017-01-30 09:19:53' ],
