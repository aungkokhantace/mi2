...
<div id="content" class="content">
    ...
    {!! Form::open(array('id'=> 'frm_menu' ,'url' => 'backend/menu/destroy', 'class'=> 'form-horizontal user-form-border')) !!}
    {{ csrf_field() }}
                ...
                <table class="table table-striped list-table" id="list-table">
                    ...
                    @foreach($menus as $menu)
                        <tr>
                            ...
                            <td><a href="/backend/menu/edit/{{$menu->id}}">{{$menu->name}}</a></td>
                            <td>{{$menu->description}}</td>
                            <td>{{$menuCategories[$menu->category]}}</td>
                            @if($menu->active == 1)
                                <td>Active</td>
                            @else
                                <td>Not Active</td>
